...
public class SidebarPageConfigAjaxBasedImpl implements SidebarPageConfig{
	...
	public SidebarPageConfigAjaxBasedImpl(){		
		pageMap.put("fn1",new SidebarPage("penjualan","Penjualan","/imgs/fn.png","/transaksi/penjualan/penjualan.zul"));
		pageMap.put("fn2",new SidebarPage("masuk","Transaksi Masuk","/imgs/fn.png","/transaksi/masuk/trmasuk.zul"));
		pageMap.put("fn3",new SidebarPage("barang","Barang","/imgs/fn.png","/master/barang/barang.zul"));
